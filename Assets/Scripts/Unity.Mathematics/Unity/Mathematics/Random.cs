...
namespace Unity.Mathematics
{
	...
	public struct Random
	{
		...
		{
			return math.asfloat(0x3F800000u | (NextState() >> 9)) - 1f;
		}
		...
		public double NextDouble()
		{
			...
			return math.asdouble(0x3FF0000000000000uL | num) - 1.0;
		}
		...
		public double2 NextDouble2()
		{
			...
			return math.double2(math.asdouble(0x3FF0000000000000uL | num), math.asdouble(0x3FF0000000000000uL | num2)) - 1.0;
		}
		...
		public double3 NextDouble3()
		{
			...
			return math.double3(math.asdouble(0x3FF0000000000000uL | num), math.asdouble(0x3FF0000000000000uL | num2), math.asdouble(0x3FF0000000000000uL | num3)) - 1.0;
		}
		...
		public double4 NextDouble4()
		{
			...
			return math.double4(math.asdouble(0x3FF0000000000000uL | num), math.asdouble(0x3FF0000000000000uL | num2), math.asdouble(0x3FF0000000000000uL | num3), math.asdouble(0x3FF0000000000000uL | num4)) - 1.0;
		}
		...
		{
			math.sincos(NextFloat() * (float)Math.PI * 2f, out var s, out var c);
		...
		public float3 NextFloat3Direction()
		{
			...
			math.sincos(obj.y * (float)Math.PI * 2f, out var s, out var c);
		...
		{
			float3 float5 = NextFloat3(math.float3((float)Math.PI * 2f, (float)Math.PI * 2f, 1f));
			float z = float5.z;
			float2 xy = float5.xy;
