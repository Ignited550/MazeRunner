...
namespace Unity.Mathematics
{
	public static class math
	{
		...
		{
			return asdouble(asulong(x) & 0x7FFFFFFFFFFFFFFFuL);
		}

		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static double2 abs(double2 x)
		{
			return double2(asdouble(asulong(x.x) & 0x7FFFFFFFFFFFFFFFuL), asdouble(asulong(x.y) & 0x7FFFFFFFFFFFFFFFuL));
		}

		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static double3 abs(double3 x)
		{
			return double3(asdouble(asulong(x.x) & 0x7FFFFFFFFFFFFFFFuL), asdouble(asulong(x.y) & 0x7FFFFFFFFFFFFFFFuL), asdouble(asulong(x.z) & 0x7FFFFFFFFFFFFFFFuL));
		}

		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static double4 abs(double4 x)
		{
			return double4(asdouble(asulong(x.x) & 0x7FFFFFFFFFFFFFFFuL), asdouble(asulong(x.y) & 0x7FFFFFFFFFFFFFFFuL), asdouble(asulong(x.z) & 0x7FFFFFFFFFFFFFFFuL), asdouble(asulong(x.w) & 0x7FFFFFFFFFFFFFFFuL));
		}
		...
		{
			x = ((x >> 1) & 0x55555555u) | ((x & 0x55555555) << 1);
			x = ((x >> 2) & 0x33333333u) | ((x & 0x33333333) << 2);
			x = ((x >> 4) & 0xF0F0F0Fu) | ((x & 0xF0F0F0F) << 4);
			x = ((x >> 8) & 0xFF00FFu) | ((x & 0xFF00FF) << 8);
			return (x >> 16) | (x << 16);
		}
		...
		{
			x = ((x >> 1) & 0x5555555555555555uL) | ((x & 0x5555555555555555L) << 1);
			x = ((x >> 2) & 0x3333333333333333uL) | ((x & 0x3333333333333333L) << 2);
			x = ((x >> 4) & 0xF0F0F0F0F0F0F0FuL) | ((x & 0xF0F0F0F0F0F0F0FL) << 4);
			x = ((x >> 8) & 0xFF00FF00FF00FFuL) | ((x & 0xFF00FF00FF00FFL) << 8);
			x = ((x >> 16) & 0xFFFF0000FFFFuL) | ((x & 0xFFFF0000FFFFL) << 16);
			return (x >> 32) | (x << 32);
		}
