...
namespace UnityEngine.ProBuilder
{
	public static class HandleUtility
	{
		...
		{
			float distance2 = float.PositiveInfinity;
			...
			for (int i = 0; i < triangles.Length; i += 3)
			{
				...
				if (Math.RayIntersectsTriangle2(origin, direction, vert, vert2, vert3, ref distance, ref normal))
				{
					num = i / 3;
					distance2 = distance;
					break;
			...
			hit = new RaycastHit(distance2, InRay.GetPoint(distance2), normal, num);
			return num > -1;
		}
